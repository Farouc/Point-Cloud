...
def augment_with_outliers(train_points, train_labels, number_of_duplicates, random_number_outliers=True):
...
if __name__ == "__main__":
    ...
    augmented_train_points, augmented_train_labels = augment_with_outliers(train_points, train_labels, number_of_duplicates=args.num_duplicates, random_number_outliers=args.random_number_outliers)
